...
import { openModal, SelectedChannelStore, showToast, Toasts, useStateFromStores } from "@webpack/common";
...
const startSummarize = (channelId: string) => {
    ...
    const { channelConfigs } = settings.store;
...
export default definePlugin({
    name: "ChatSummaries",
    description: "AI chat summarization",
    authors: [
        {
            name: "komi-juru",
            id: 682762388143210549n
        }
    ],
    github: "https://github.com/komi-juru/ChatSummaries",
